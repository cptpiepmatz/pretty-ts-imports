...
module.exports={
    ...
    "scripts": {
        ...
        "run-dev": "ts-node .",
        "build": "npm run build:clean && npm run build:tsc && npm run build:bundle && npm run build:minify",
        "build:clean": "del-cli dist & del-cli out",
        "build:tsc": "tsc",
        "build:bundle": "browserify out/src/cli.js --node -o dist/cli.bundle.js --no-bundle-external",
        "build:minify": "terser dist/cli.bundle.js -o dist/cli.bundle.min.js",
